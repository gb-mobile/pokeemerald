...
const u8 gText_Atk[] = _("Atk");
const u8 gText_Def[] = _("Def");
const u8 gText_Spd[] = _("Spd   ");
const u8 gText_SpAtk5[] = _("Sp.A ");
const u8 gText_SpDef5[] = _("Sp.D ");
...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature, met at\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature,\nhatched at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureObtainedInTrade[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature,\nobtained in a trade on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1}.");
...
const u8 gText_Month_January[] = _("Jan.");
const u8 gText_Month_February[] = _("Feb.");
const u8 gText_Month_March[] = _("Mar.");
const u8 gText_Month_April[] = _("Apr.");
const u8 gText_Month_May[] = _("May");
const u8 gText_Month_June[] = _("June");
const u8 gText_Month_July[] = _("July");
const u8 gText_Month_August[] = _("Aug.");
const u8 gText_Month_September[] = _("Sep.");
...
const u8 gText_EnergyPowder50[] = _("Energypowder{CLEAR_TO 0x72}{FONT_SMALL}50");
const u8 gText_EnergyRoot80[] = _("Energy Root{CLEAR_TO 0x72}{FONT_SMALL}80");
const u8 gText_HealPowder50[] = _("Heal Powder{CLEAR_TO 0x72}{FONT_SMALL}50");
const u8 gText_RevivalHerb300[] = _("Revival Herb{CLEAR_TO 0x6C}{FONT_SMALL}300");
const u8 gText_Protein1000[] = _("Protein{CLEAR_TO 0x63}{FONT_SMALL}1,000");
const u8 gText_Iron1000[] = _("Iron{CLEAR_TO 0x63}{FONT_SMALL}1,000");
const u8 gText_Carbos1000[] = _("Carbos{CLEAR_TO 0x63}{FONT_SMALL}1,000");
const u8 gText_Calcium1000[] = _("Calcium{CLEAR_TO 0x63}{FONT_SMALL}1,000");
const u8 gText_Zinc1000[] = _("Zinc{CLEAR_TO 0x63}{FONT_SMALL}1,000");
const u8 gText_HPUp1000[] = _("HP Up{CLEAR_TO 0x63}{FONT_SMALL}1,000");
const u8 gText_PPUp3000[] = _("PP Up{CLEAR_TO 0x63}{FONT_SMALL}3,000");
...
const u8 gText_OccaBerry5BP[] = _("Occa Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_PasshoBerry5BP[] = _("Passho Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_WacanBerry5BP[] = _("Wacan Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_RindoBerry5BP[] = _("Rindo Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_YacheBerry5BP[] = _("Yache Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_ChopleBerry5BP[] = _("Chople Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_KebiaBerry5BP[] = _("Kebia Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_ShucaBerry5BP[] = _("Shuca Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_CobaBerry5BP[] = _("Coba Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_PayapaBerry5BP[] = _("Payapa Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_TangaBerry5BP[] = _("Tanga Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_ChartiBerry5BP[] = _("Charti Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_KasibBerry5BP[] = _("Kasib Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_HabanBerry5BP[] = _("Haban Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_ColburBerry5BP[] = _("Colbur Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_BabiriBerry5BP[] = _("Babiri Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_ChilanBerry5BP[] = _("Chilan Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_MicleBerry5BP[] = _("Micle Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_CustapBerry5BP[] = _("Custap Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_JabocaBerry5BP[] = _("Jaboca Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_RowapBerry5BP[] = _("Rowap Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_RoseliBerry5BP[] = _("Roseli Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_KeeBerry5BP[] = _("Kee Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_MarangaBerry5BP[] = _("Maranga Berry{CLEAR_TO 0x5E}5BP");
const u8 gText_RedApricorn10BP[] = _("Red Apricorn{CLEAR_TO 0x5E}10BP");
const u8 gText_BlueApricorn10BP[] = _("Blue Apricorn{CLEAR_TO 0x5E}10BP");
const u8 gText_YellowApricorn10BP[] = _("Yellow Apricorn{CLEAR_TO 0x5E}10BP");
const u8 gText_GreenApricorn10BP[] = _("Green Apricorn{CLEAR_TO 0x5E}10BP");
const u8 gText_PinkApricorn10BP[] = _("Pink Apricorn{CLEAR_TO 0x5E}10BP");
const u8 gText_WhiteApricorn10BP[] = _("White Apricorn{CLEAR_TO 0x5E}10BP");
const u8 gText_BlackApricorn10BP[] = _("Black Apricorn{CLEAR_TO 0x5E}10BP");
const u8 gText_NormalGem32BP[] = _("Normal Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_FireGem32BP[] = _("Fire Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_WaterGem32BP[] = _("Water Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_ElectricGem32BP[] = _("Electric Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_GrassGem32BP[] = _("Grass Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_IceGem32BP[] = _("Ice Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_FightingGem32BP[] = _("Fighting Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_PoisonGem32BP[] = _("Poison Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_GroundGem32BP[] = _("Ground Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_FlyingGem32BP[] = _("Flying Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_PsychicGem32BP[] = _("Psychic Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_BugGem32BP[] = _("Bug Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_RockGem32BP[] = _("Rock Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_GhostGem32BP[] = _("Ghost Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_DragonGem32BP[] = _("Dragon Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_DarkGem32BP[] = _("Dark Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_SteelGem32BP[] = _("Steel Gem{CLEAR_TO 0x5E}32BP");
const u8 gText_FairyGem32BP[] = _("Fairy Gem{CLEAR_TO 0x5E}32BP");
...
const u8 gText_PowerAnklet16BP[] = _("Power Anklet{CLEAR_TO 0x64}16BP");
const u8 gText_PowerBand16BP[] = _("Power Band{CLEAR_TO 0x64}16BP");
const u8 gText_PowerBelt16BP[] = _("Power Belt{CLEAR_TO 0x64}16BP");
const u8 gText_PowerBracer16BP[] = _("Power Bracer{CLEAR_TO 0x64}16BP");
const u8 gText_PowerLens16BP[] = _("Power Lens{CLEAR_TO 0x64}16BP");
const u8 gText_PowerWeight16BP[] = _("Power Weight{CLEAR_TO 0x64}16BP");
const u8 gText_RareCandy48BP[] = _("Rare Candy{CLEAR_TO 0x64}48BP");
const u8 gText_ToxicOrb16BP[] = _("Toxic Orb{CLEAR_TO 0x5E}16BP");
const u8 gText_FlameOrb16BP[] = _("Flame Orb{CLEAR_TO 0x5E}16BP");
const u8 gText_WhiteHerb32BP[] = _("White Herb{CLEAR_TO 0x5E}32BP");
const u8 gText_PowerHerb32BP[] = _("Power Herb{CLEAR_TO 0x5E}32BP");
const u8 gText_MentalHerb32BP[] = _("Mental Herb{CLEAR_TO 0x5E}32BP");
const u8 gText_AbsorbBulb32BP[] = _("Absorb Bulb{CLEAR_TO 0x5E}32BP");
const u8 gText_CellBattery32BP[] = _("Cell Battery{CLEAR_TO 0x5E}32BP");
const u8 gText_RedCard32BP[] = _("Red Card{CLEAR_TO 0x5E}32BP");
const u8 gText_EjectButton32BP[] = _("Eject Button{CLEAR_TO 0x5E}32BP");
const u8 gText_WeaknessPolicy32BP[] = _("Weakness Policy{CLEAR_TO 0x5E}32BP");
const u8 gText_RingTarget32BP[] = _("Ring Target{CLEAR_TO 0x5E}32BP");
const u8 gText_WiseGlasses48BP[] = _("Wise Glasses{CLEAR_TO 0x5E}48BP");
const u8 gText_AssaultVest48BP[] = _("Assault Vest{CLEAR_TO 0x5E}48BP");
const u8 gText_FocusSash48BP[] = _("Focus Sash{CLEAR_TO 0x5E}48BP");
const u8 gText_Brightpowder48BP[] = _("Brightpowder{CLEAR_TO 0x5E}48BP");
const u8 gText_IronBall48BP[] = _("Iron Ball{CLEAR_TO 0x5E}48BP");
const u8 gText_AirBalloon48BP[] = _("Air Balloon{CLEAR_TO 0x5E}48BP");
const u8 gText_BindingBand48BP[] = _("Binding Band{CLEAR_TO 0x5E}48BP");
const u8 gText_SafetyGoggles48BP[] = _("Safety Goggles{CLEAR_TO 0x5E}48BP");
const u8 gText_Leftovers48BP[] = _("Leftovers{CLEAR_TO 0x5E}48BP");
const u8 gText_ScopeLens64BP[] = _("ScopeLens{CLEAR_TO 0x5E}64BP");
const u8 gText_ZoomLens64BP[] = _("Zoom Lens{CLEAR_TO 0x5E}64BP");
const u8 gText_WideLens64BP[] = _("Wide Lens{CLEAR_TO 0x5E}64BP");
const u8 gText_MuscleBand64BP[] = _("Muscle Band{CLEAR_TO 0x5E}64BP");
const u8 gText_FocusBand64BP[] = _("Focus Band{CLEAR_TO 0x5E}64BP");
const u8 gText_ChoiceSpecs64BP[] = _("Choice Specs{CLEAR_TO 0x5E}64BP");
const u8 gText_ChoiceBand64BP[] = _("Choice Band{CLEAR_TO 0x5E}64BP");
const u8 gText_ChoiceScarf64BP[] = _("Choice Scarf{CLEAR_TO 0x5E}64BP");
const u8 gText_LifeOrb64BP[] = _("Life Orb{CLEAR_TO 0x5E}64BP");
const u8 gText_AbilityCapsule200BP[] = _("Ability Capsule{CLEAR_TO 0x5D}200BP");
...
const u8 gText_XReturned[] = _("{STR_VAR_3} was returned!");
const u8 gText_WelcomeBackX[] = _("Welcome back {STR_VAR_3}!");
...
ALIGNED(4) const u8 gText_MobileAdapterNotPluggedIn[] = _("The mobile adapter is not plugged in\ncorrectly.\pPlease refer to the instruction manual\nand plug it in firmly.");
ALIGNED(4) const u8 gText_MobileAdapterTroubleMakingCall[] = _("You are unable to communicate because\nyou are having trouble making a call or\lthe line is busy.\pPlease wait a moment and try again.\pPlease see the operating instructions\nfor more information.");
ALIGNED(4) const u8 gText_MobileAdapterLineBusy[] = _("The line is busy and communication is\nnot possible.\pPlease wait a moment and try\ncommunicating again.");
ALIGNED(4) const u8 gText_MobileAdapterError[] = _("Mobile adapter error.\pPlease wait a moment and try\ncommunicating again.\pIf the problem is not fixed, please\nrefer to the user manual.\pIf the problem persists, please refer\nto the user manual and contact the\lmobile support centre.");
ALIGNED(4) const u8 gText_MobileAdapterCommunicationError[] = _("Communication error. Please wait for a\nwhile and try communicating again.\pIf the problem is not fixed, please\nrefer to the user manual.\pIf the problem persists, please refer\nto the user manual and contact the\lmobile support centre.");
ALIGNED(4) const u8 gText_MobileAdapterWrongCredentials[] = _("There is a mistake in your password or\nlogin ID.\pPlease check your password and wait a\nmoment before communicating again.\pPlease see the instruction manual for\nmore information.");
ALIGNED(4) const u8 gText_MobileAdapterDisconnected[] = _("Communication has been disconnected.\pPlease refer to the instruction manual\nand wait a moment before communicating\lagain.");
ALIGNED(4) const u8 gText_MobileAdapterServerError[] = _("Server communication error. Please wait\na moment and then try communicating\lagain.\pPlease see the instruction manual for\nmore information.");
ALIGNED(4) const u8 gText_MobileAdapterIncorrectInformation[] = _("The information registered in the\nmobile adapter is incorrect.\pPlease do the initial registration in\nthe Mobile Trainer.");
ALIGNED(4) const u8 gText_MobileAdapterServerBusy[] = _("The server is busy and cannot\ncommunicate.\pPlease wait a moment and try again.\pPlease see the instruction manual for\nmore information.");
ALIGNED(4) const u8 gText_MobileAdapterIncorrectDestination[] = _("Incorrect destination email address.\pPlease enter the correct email address.");
ALIGNED(4) const u8 gText_MobileAdapterIncorrectEmail[] = _("Incorrect email address.\pPlease read the instruction manual.\pPlease register initially in the Mobile\nTrainer.");
ALIGNED(4) const u8 gText_MobileAdapterPaswordOrServerError[] = _("Either your password is incorrect or\nthere is a server error.\pPlease check your password and wait a\nmoment before communicating again.");
ALIGNED(4) const u8 gText_MobileAdapterCannotDownload[] = _("Content cannot be downloaded.\pPlease wait a moment and try again.\pIf the problem persists, please refer\nto the user manual and contact the\lmobile support centre.");
ALIGNED(4) const u8 gText_MobileAdapterCommunicationTerminated[] = _("Communication has been terminated due\nto a time-out. Please try again.\pPlease see the instruction manual for\nmore information.");
ALIGNED(4) const u8 gText_MobileAdapterOwnConvenience[] = _("Communication has been terminated due\nto a time-out. Please try again.\pPlease see the instruction manual for\nmore information.");
ALIGNED(4) const u8 gText_MobileAdapterCommunicationNotPossible[] = _("Communication is not possible because\nthe line is busy or there is an error on\lthe server.\pPlease wait a moment and then try to\ncommunicate again.\pFor further information, please refer\nto the operating instructions.");
ALIGNED(4) const u8 gText_MobileAdapterUsageFeeExceeded[] = _("You cannot use the service this month\nbecause your usage fee has exceeded\lthe limit.\pPlease see the user manual for more\ninformation.");
ALIGNED(4) const u8 gText_MobileAdapterUnderMaintenance[] = _("The service is currently under\nmaintenance and is not available.\pPlease wait a moment and then call\nback.\pFor further information, please refer \nto the operating instructions.");
ALIGNED(4) const u8 gText_MobileAdapterCantDownload[] = _("You can't download content.\pPlease see the instruction manual for\nmore information.");
ALIGNED(4) const u8 gText_MobileAdapterRegistrationNotProcessed[] = _("It seems that the registration form\nhas not been processed.\pPlease wait a moment while the process\nis completed.");
ALIGNED(4) const u8 gText_MobileAdapterInternalError[] = _("An internal error has occurred.\pPlease refer to the instruction manual\nand contact the mobile support centre.");
