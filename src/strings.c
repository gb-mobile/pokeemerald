...
const u8 gText_DecideStop[] = _("{A_BUTTON}OK {B_BUTTON}CANCEL");
const u8 gText_ReceiveMysteryGiftWithEReader[] = _("Here, you can read MYSTERY GIFT\ncards with the e-Reader.");
const u8 gText_SelectConnectFromEReaderMenu[] = _("To connect, choose the “Communication”\noption from the e-Reader menu.");
const u8 gText_SelectConnectWithGBA[] = _("To connect, choose the “Communication”\noption from the e-Reader menu.");
const u8 gText_SelectConnectAndPressA[] = _("Select “Connect” on the e-Reader\nand press the A button."); // Unused
const u8 gText_LinkIsIncorrect[] = _("The link is invalid.");
const u8 gText_CardReadingHasBeenHalted[] = _("Stopped reading the card.");
const u8 gText_UnableConnectWithEReader[] = _("Unable to connect to the e-Reader."); // Unused
const u8 gText_Connecting[] = _("Connecting…");
const u8 gText_ConnectionErrorCheckLink[] = _("Communication error.\nPlease check the connection.");
const u8 gText_ConnectionErrorTryAgain[] = _("Communication error.\nPlease try again."); // Link error
const u8 gText_AllowEReaderToLoadCard[] = _("Please scan the card into\nthe e-Reader.");
const u8 gText_ConnectionComplete[] = _("Transfer complete!");
const u8 gText_NewTrainerHasComeToHoenn[] = _("A new TRAINER has arrived in HOENN.");
const u8 gText_PleaseWaitAMoment[] = _("Please wait…");
const u8 gText_WriteErrorUnableToSaveData[] = _("Write error.\nData could not be saved.");
