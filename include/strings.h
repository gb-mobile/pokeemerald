...
extern const u8 gText_OccaBerry5BP[];
extern const u8 gText_PasshoBerry5BP[];
extern const u8 gText_WacanBerry5BP[];
extern const u8 gText_RindoBerry5BP[];
extern const u8 gText_YacheBerry5BP[];
extern const u8 gText_ChopleBerry5BP[];
extern const u8 gText_KebiaBerry5BP[];
extern const u8 gText_ShucaBerry5BP[];
extern const u8 gText_CobaBerry5BP[];
extern const u8 gText_PayapaBerry5BP[];
extern const u8 gText_TangaBerry5BP[];
extern const u8 gText_ChartiBerry5BP[];
extern const u8 gText_KasibBerry5BP[];
extern const u8 gText_HabanBerry5BP[];
extern const u8 gText_ColburBerry5BP[];
extern const u8 gText_BabiriBerry5BP[];
extern const u8 gText_ChilanBerry5BP[];
extern const u8 gText_MicleBerry5BP[];
extern const u8 gText_CustapBerry5BP[];
extern const u8 gText_JabocaBerry5BP[];
extern const u8 gText_RowapBerry5BP[];
extern const u8 gText_RoseliBerry5BP[];
extern const u8 gText_KeeBerry5BP[];
extern const u8 gText_MarangaBerry5BP[];
extern const u8 gText_RedApricorn10BP[];
extern const u8 gText_BlueApricorn10BP[];
extern const u8 gText_YellowApricorn10BP[];
extern const u8 gText_GreenApricorn10BP[];
extern const u8 gText_PinkApricorn10BP[];
extern const u8 gText_WhiteApricorn10BP[];
extern const u8 gText_BlackApricorn10BP[];

extern const u8 gText_NormalGem32BP[];
extern const u8 gText_FireGem32BP[];
extern const u8 gText_WaterGem32BP[];
extern const u8 gText_ElectricGem32BP[];
extern const u8 gText_GrassGem32BP[];
extern const u8 gText_IceGem32BP[];
extern const u8 gText_FightingGem32BP[];
extern const u8 gText_PoisonGem32BP[];
extern const u8 gText_GroundGem32BP[];
extern const u8 gText_FlyingGem32BP[];
extern const u8 gText_PsychicGem32BP[];
extern const u8 gText_BugGem32BP[];
extern const u8 gText_RockGem32BP[];
extern const u8 gText_GhostGem32BP[];
extern const u8 gText_DragonGem32BP[];
extern const u8 gText_DarkGem32BP[];
extern const u8 gText_SteelGem32BP[];
extern const u8 gText_FairyGem32BP[];
...
extern const u8 gText_RareCandy48BP[];

extern const u8 gText_ToxicOrb16BP[];
extern const u8 gText_FlameOrb16BP[];
extern const u8 gText_WhiteHerb32BP[];
extern const u8 gText_PowerHerb32BP[];
extern const u8 gText_MentalHerb32BP[];
extern const u8 gText_AbsorbBulb32BP[];
extern const u8 gText_CellBattery32BP[];
extern const u8 gText_RedCard32BP[];
extern const u8 gText_EjectButton32BP[];
extern const u8 gText_WeaknessPolicy32BP[];
extern const u8 gText_RingTarget32BP[];
extern const u8 gText_WiseGlasses48BP[];
extern const u8 gText_AssaultVest48BP[];
extern const u8 gText_FocusSash48BP[];
extern const u8 gText_Brightpowder48BP[];
extern const u8 gText_IronBall48BP[];
extern const u8 gText_AirBalloon48BP[];
extern const u8 gText_BindingBand48BP[];
extern const u8 gText_SafetyGoggles48BP[];
extern const u8 gText_Leftovers48BP[];
extern const u8 gText_ScopeLens64BP[];
extern const u8 gText_ZoomLens64BP[];
extern const u8 gText_WideLens64BP[];
...
extern const u8 gText_LifeOrb64BP[];
extern const u8 gText_AbilityCapsule200BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_OccaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PasshoBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WacanBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RindoBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_YacheBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ChopleBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_KebiaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ShucaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CobaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PayapaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_TangaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ChartiBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_KasibBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_HabanBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ColburBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BabiriBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ChilanBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MicleBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CustapBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_JabocaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RowapBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RoseliBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_KeeBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MarangaBerryDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RedApricornDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BlueApricornDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_YellowApricornDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GreenApricornDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PinkApricornDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WhiteApricornDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BlackApricornDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_NormalGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FireGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WaterGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ElectricGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GrassGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_IceGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FightingGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PoisonGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GroundGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FlyingGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PsychicGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BugGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RockGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GhostGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DragonGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DarkGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SteelGemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FairyGemDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PowerAnkletDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PowerBandDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PowerBeltDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PowerBracerDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PowerLensDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PowerWeightDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AbsorbBulbDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CellBatteryDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RingTargetDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_IronBallDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AirBalloonDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BindingBandDesc[];
...
extern const u8 gText_Spd[];
extern const u8 gText_SpAtk5[];
extern const u8 gText_SpDef5[];
...
// Frontier Gym Leaders
extern const u8 gText_DummyText[];
extern const u8 gText_BrockIntro[];
extern const u8 gText_BrockWon[];
extern const u8 gText_BrockDefeat[];
extern const u8 gText_MistyIntro[];
extern const u8 gText_MistyWon[];
extern const u8 gText_MistyDefeat[];
extern const u8 gText_SurgeIntro[];
extern const u8 gText_SurgeWon[];
extern const u8 gText_SurgeDefeat[];
extern const u8 gText_ErikaIntro[];
extern const u8 gText_ErikaWon[];
extern const u8 gText_ErikaDefeat[];
extern const u8 gText_JanineIntro[];
extern const u8 gText_JanineWon[];
extern const u8 gText_JanineDefeat[];
extern const u8 gText_SabrinaIntro[];
extern const u8 gText_SabrinaWon[];
extern const u8 gText_SabrinaDefeat[];
extern const u8 gText_BlaineIntro[];
extern const u8 gText_BlaineWon[];
extern const u8 gText_BlaineDefeat[];
extern const u8 gText_GiovanniIntro[];
extern const u8 gText_GiovanniWon[];
extern const u8 gText_GiovanniDefeat[];

extern const u8 gText_FalknerIntro[];
extern const u8 gText_FalknerWon[];
extern const u8 gText_FalknerDefeat[];
extern const u8 gText_BugsyIntro[];
extern const u8 gText_BugsyWon[];
extern const u8 gText_BugsyDefeat[];
extern const u8 gText_WhitneyIntro[];
extern const u8 gText_WhitneyWon[];
extern const u8 gText_WhitneyDefeat[];
extern const u8 gText_MortyIntro[];
extern const u8 gText_MortyWon[];
extern const u8 gText_MortyDefeat[];
extern const u8 gText_ChuckIntro[];
extern const u8 gText_ChuckWon[];
extern const u8 gText_ChuckDefeat[];
extern const u8 gText_JasmineIntro[];
extern const u8 gText_JasmineWon[];
extern const u8 gText_JasmineDefeat[];
extern const u8 gText_PryceIntro[];
extern const u8 gText_PryceWon[];
extern const u8 gText_PryceDefeat[];
extern const u8 gText_ClairIntro[];
extern const u8 gText_ClairWon[];
extern const u8 gText_ClairDefeat[];

extern const u8 gText_RoxanneIntro[];
extern const u8 gText_RoxanneWon[];
extern const u8 gText_RoxanneDefeat[];
extern const u8 gText_BrawlyIntro[];
extern const u8 gText_BrawlyWon[];
extern const u8 gText_BrawlyDefeat[];
extern const u8 gText_WattsonIntro[];
extern const u8 gText_WattsonWon[];
extern const u8 gText_WattsonDefeat[];
extern const u8 gText_FlanneryIntro[];
extern const u8 gText_FlanneryWon[];
extern const u8 gText_FlanneryDefeat[];
extern const u8 gText_NormanIntro[];
extern const u8 gText_NormanWon[];
extern const u8 gText_NormanDefeat[];
extern const u8 gText_WinonaIntro[];
extern const u8 gText_WinonaWon[];
extern const u8 gText_WinonaDefeat[];
extern const u8 gText_TateIntro[];
extern const u8 gText_TateWon[];
extern const u8 gText_TateDefeat[];
extern const u8 gText_LizaIntro[];
extern const u8 gText_LizaWon[];
extern const u8 gText_LizaDefeat[];
extern const u8 gText_WallaceIntro[];
extern const u8 gText_WallaceWon[];
extern const u8 gText_WallaceDefeat[];

extern const u8 gText_RoarkIntro[];
extern const u8 gText_RoarkWon[];
extern const u8 gText_RoarkDefeat[];
extern const u8 gText_GardeniaIntro[];
extern const u8 gText_GardeniaWon[];
extern const u8 gText_GardeniaDefeat[];
extern const u8 gText_MayleneIntro[];
extern const u8 gText_MayleneWon[];
extern const u8 gText_MayleneDefeat[];
extern const u8 gText_WakeIntro[];
extern const u8 gText_WakeWon[];
extern const u8 gText_WakeDefeat[];
extern const u8 gText_FantinaIntro[];
extern const u8 gText_FantinaWon[];
extern const u8 gText_FantinaDefeat[];
extern const u8 gText_ByronIntro[];
extern const u8 gText_ByronWon[];
extern const u8 gText_ByronDefeat[];
extern const u8 gText_CandiceIntro[];
extern const u8 gText_CandiceWon[];
extern const u8 gText_CandiceDefeat[];
extern const u8 gText_VolknerIntro[];
extern const u8 gText_VolknerWon[];
extern const u8 gText_VolknerDefeat[];

extern const u8 gText_CilanIntro[];
extern const u8 gText_CilanWon[];
extern const u8 gText_CilanDefeat[];
extern const u8 gText_ChiliIntro[];
extern const u8 gText_ChiliWon[];
extern const u8 gText_ChiliDefeat[];
extern const u8 gText_CressIntro[];
extern const u8 gText_CressWon[];
extern const u8 gText_CressDefeat[];
extern const u8 gText_LenoraIntro[];
extern const u8 gText_LenoraWon[];
extern const u8 gText_LenoraDefeat[];
extern const u8 gText_BurghIntro[];
extern const u8 gText_BurghWon[];
extern const u8 gText_BurghDefeat[];
extern const u8 gText_ElesaIntro[];
extern const u8 gText_ElesaWon[];
extern const u8 gText_ElesaDefeat[];
extern const u8 gText_ClayIntro[];
extern const u8 gText_ClayWon[];
extern const u8 gText_ClayDefeat[];
extern const u8 gText_SkylaIntro[];
extern const u8 gText_SkylaWon[];
extern const u8 gText_SkylaDefeat[];
extern const u8 gText_BrycenIntro[];
extern const u8 gText_BrycenWon[];
extern const u8 gText_BrycenDefeat[];
extern const u8 gText_DraydenIntro[];
extern const u8 gText_DraydenWon[];
extern const u8 gText_DraydenDefeat[];
extern const u8 gText_CherenIntro[];
extern const u8 gText_CherenWon[];
extern const u8 gText_CherenDefeat[];
extern const u8 gText_RoxieIntro[];
extern const u8 gText_RoxieWon[];
extern const u8 gText_RoxieDefeat[];
extern const u8 gText_MarlonIntro[];
extern const u8 gText_MarlonWon[];
extern const u8 gText_MarlonDefeat[];

extern const u8 gText_RedIntro[];
extern const u8 gText_RedWon[];
extern const u8 gText_RedDefeat[];
extern const u8 gText_BlueIntro[];
extern const u8 gText_BlueWon[];
extern const u8 gText_BlueDefeat[];
extern const u8 gText_LanceIntro[];
extern const u8 gText_LanceWon[];
extern const u8 gText_LanceDefeat[];
extern const u8 gText_StevenIntro[];
extern const u8 gText_StevenWon[];
extern const u8 gText_StevenDefeat[];
extern const u8 gText_CynthiaIntro[];
extern const u8 gText_CynthiaWon[];
extern const u8 gText_CynthiaDefeat[];
extern const u8 gText_AlderIntro[];
extern const u8 gText_AlderWon[];
extern const u8 gText_AlderDefeat[];
extern const u8 gText_IrisIntro[];
extern const u8 gText_IrisWon[];
extern const u8 gText_IrisDefeat[];
