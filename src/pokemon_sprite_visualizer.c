...
static void LoadBattleBg(u8 battleBgType, u8 battleTerrain)
{
    ...
    case MAP_BATTLE_SCENE_NORMAL:
        ...
        LoadCompressedPalette(sBattleTerrainTable[battleTerrain].palette[1], 0x20, 0x60);
        break;
...
void CB2_Pokemon_Sprite_Visualizer(void)
{
    ...
    switch (gMain.state)
    {
        ...
        case 3:
            ...
            //Front
            HandleLoadSpecialPokePic(TRUE, gMonSpritesGfxPtr->spritesGfx[1], species, (data->isFemale ? FEMALE_PERSONALITY : MALE_PERSONALITY), VERSION_EMERALD);
            data->isShiny = FALSE;
            data->isFemale = FALSE;
            ...
            //Back
            HandleLoadSpecialPokePic(FALSE, gMonSpritesGfxPtr->spritesGfx[2], species, (data->isFemale ? FEMALE_PERSONALITY : MALE_PERSONALITY), VERSION_EMERALD);
