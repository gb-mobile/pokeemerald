...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEECH_SEED, MOVE_PAYBACK, MOVE_NEEDLE_ARM, MOVE_SPIKY_SHIELD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_ICE_SHARD, MOVE_HAIL, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSE_RAY, MOVE_BLIZZARD, MOVE_HAIL, MOVE_OMINOUS_WIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    .species = SPECIES_GLALIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_ICE_SHARD, MOVE_HAIL, MOVE_FREEZE_DRY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_SURF, MOVE_YAWN, MOVE_ICE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 53,
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .species = SPECIES_SEAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_HORN_DRILL, MOVE_FURY_ATTACK, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 46,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_TWISTER, MOVE_ICE_BEAM, MOVE_RECOVER}
    }
};
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTH_POWER, MOVE_EXTRASENSORY, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_IRON_TAIL, MOVE_DRAGON_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_X_SCISSOR, MOVE_ROCK_BLAST, MOVE_METAL_CLAW, MOVE_CRUSH_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
...
static const struct TrainerMon sParty_GruntSouthernisland[] = {
    {
    .lvl = 29,
    .species = SPECIES_KOFFING,
    }
...
static const struct TrainerMon sParty_WallyVR5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_LEECH_SEED, MOVE_PETAL_BLIZZARD, MOVE_POISON_JAB}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 79,
    ...
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AQUA_JET, MOVE_PLAY_ROUGH, MOVE_AQUA_TAIL, MOVE_IRON_TAIL}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 79,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_DISCHARGE, MOVE_REFLECT, MOVE_FLASH_CANNON}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 79,
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_GALLADITE,
    .moves = {MOVE_PSYCHO_CUT, MOVE_CLOSE_COMBAT, MOVE_LEAF_BLADE, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_Steven_SouthernIsland[] = {
    {
    .iv = 0,
    .lvl = 35,
...
static const struct TrainerMon sParty_Sidney2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_SHADOW_CLAW, MOVE_DARK_PULSE, MOVE_FLAMETHROWER}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRAVE_BIRD, MOVE_BONE_RUSH, MOVE_FEINT_ATTACK, MOVE_TAILWIND}
    },
    {
    .iv = 255,
    .lvl = 72,
...
static const struct TrainerMon sParty_Phoebe2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_POWER_GEM, MOVE_THUNDERBOLT, MOVE_PAIN_SPLIT}
    },
    {
    .iv = 250,
    .lvl = 71,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_PSYCHIC, MOVE_ICY_WIND, MOVE_ACROBATICS}
    },
    {
    .iv = 250,
    .lvl = 71,
...
static const struct TrainerMon sParty_Glacia2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICICLE_CRASH, MOVE_SLASH, MOVE_SHADOW_CLAW, MOVE_BRICK_BREAK}
    },
    {
    .iv = 250,
    .lvl = 72,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_MIRROR_COAT, MOVE_FREEZE_DRY, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 255,
    .lvl = 72,
...
static const struct TrainerMon sParty_Drake2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_SHADOW_CLAW}
    },
    {
    .iv = 255,
    .lvl = 75,
...
static const struct TrainerMon sParty_Steven2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_POWER_GEM, MOVE_PSYCHIC, MOVE_EARTH_POWER}
    },
    {
    .iv = 255,
    .lvl = 77,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_ICE_FANG, MOVE_THUNDER_FANG, MOVE_FIRE_FANG}
    },
    {
    .iv = 255,
    .lvl = 77,
...
static const struct TrainerMon sParty_Sidney3[] = {
    {
    .iv = 250,
    .lvl = 75,
    .species = SPECIES_SCRAFTY,
...
static const struct TrainerMon sParty_Phoebe3[] = {
    {
    .iv = 250,
    .lvl = 76,
    .species = SPECIES_BANETTE,
...
static const struct TrainerMon sParty_Glacia3[] = {
    {
    .iv = 250,
    .lvl = 77,
    .species = SPECIES_ABOMASNOW,
...
static const struct TrainerMon sParty_Drake3[] = {
    {
    .iv = 250,
    .lvl = 78,
    .species = SPECIES_ALTARIA,
...
static const struct TrainerMon sParty_Sidney4[] = {
    {
    .iv = 250,
    .lvl = 80,
    .species = SPECIES_SCRAFTY,
...
static const struct TrainerMon sParty_Phoebe4[] = {
    {
    .iv = 250,
    .lvl = 81,
    .species = SPECIES_BANETTE,
...
static const struct TrainerMon sParty_Glacia4[] = {
    {
    .iv = 250,
    .lvl = 82,
    .species = SPECIES_ABOMASNOW,
...
static const struct TrainerMon sParty_Drake4[] = {
    {
    .iv = 250,
    .lvl = 83,
    .species = SPECIES_ALTARIA,
...
static const struct TrainerMon sParty_Steven4[] = {
    {
    .iv = 255,
    .lvl = 87,
    .species = SPECIES_SKARMORY,
...
static const struct TrainerMon sParty_Sidney5[] = {
    {
    .iv = 250,
    .lvl = 90,
    .species = SPECIES_SCRAFTY,
...
static const struct TrainerMon sParty_Phoebe5[] = {
    {
    .iv = 250,
    .lvl = 91,
    .species = SPECIES_BANETTE,
...
static const struct TrainerMon sParty_Glacia5[] = {
    {
    .iv = 250,
    .lvl = 92,
    .species = SPECIES_ABOMASNOW,
...
static const struct TrainerMon sParty_Drake5[] = {
    {
    .iv = 250,
    .lvl = 93,
    .species = SPECIES_ALTARIA,
...
static const struct TrainerMon sParty_Steven5[] = {
    {
    .iv = 255,
    .lvl = 97,
    .species = SPECIES_SKARMORY,
