...
static const struct TrainerHillTrainer sTrainerHillTrainerTemplates_JP[] = {
    [0] = {
        ...
        .speechLose = { EC_WORD_YOU, EC_WORD_WON, EC_WORD_QUES, EC_WORD_HOW, EC_WORD_SCARY, EC_WORD_EXCL },
        .speechAfter = { EC_WORD_THIS, EC_WORD_NIGHT, EC_WORD_YOU, EC_WORD_WILL, EC_WORD_SEE, EC_WORD_ELLIPSIS },
        .mons = {
            [0] = DUMMY_HILL_MON,
            [1] = DUMMY_HILL_MON,
            [2] = DUMMY_HILL_MON,
    ...
    [2] = {
        ...
        .speechLose = { EC_WORD_LOOKS, EC_WORD_LIKE, EC_WORD_I, EC_WORD_LOST, EC_WORD_ELLIPSIS, EC_EMPTY_WORD },
    ...
    [3] = {
        ...
        .speechLose = { EC_WORD_WOW, EC_WORD_EXCL, EC_EMPTY_WORD, EC_WORD_THAT_WAS, EC_WORD_A, EC_WORD_SURPRISE },
